      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white dark:bg-slate-800 rounded-2xl p-12 shadow-lg max-w-2xl w-full text-center"
          >
            <motion.div
              ...
              className="mb-8"
            >
              <div className="w-20 h-20 bg-gradient-to-r from-green-500 via-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6">
